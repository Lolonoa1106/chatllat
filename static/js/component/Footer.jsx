                ...
                <div className="grow flex flex-wrap justify-between gap-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 font-normal tracking-wide">
                      ...
                      <li><Link to="/faqs" className="text-gray-900 hover:text-white transition-colors">FAQs</Link></li>
                    </ul>
                  </div>                      
                  <div className="space-y-4">
                    <div className="flex flex-col gap-1">
                    ...
                    <ul className="space-y-2 font-normal tracking-wide">
                      ...
                      <li><Link to="/terms-and-condition" className="text-gray-900 hover:text-white transition-colors">Terms & Condition</Link></li>
                      <li><Link to="/privacy-policy" className="text-gray-900 hover:text-white transition-colors">Privacy Policy</Link></li>
