    ...
    e0ca: function (t, i, e) {
      ...
      function c(t) {
        for (var i = 1; i < arguments.length; i++) {
          ...
          i % 2
            ? r(Object(e), !0).forEach(function (i) {
                h(t, i, e[i]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e))
            : r(Object(e)).forEach(function (i) {
            ...
            {},
            {
              ...
              getModifierClass: function () {
                return this.isBottom || this.isCenter
                  ? this.isCenter
                    ? this.isRight
                      ? "tawk-min-chat-icon-right"
                      : "tawk-min-chat-icon-left"
                    : "tawk-min-chat-icon-down"
                  : "tawk-min-chat-icon-up";
              },
            }
          ),
          watch: {
                      ...
                      i("div", [
                        t.firstActiveProfile || "min" !== t.chatWindowState
                          ...
                          : i(
                              ...
                              [
                                i("title", { attrs: { id: "openIconTitle" } }, [
                                  t._v("Opens Chat"),
                                ]),
                                i("desc", { attrs: { id: "openIconDesc" } }, [
      ...
      function g(t) {
        for (var i = 1; i < arguments.length; i++) {
          var e = null != arguments[i] ? arguments[i] : {};
          i % 2
            ? u(Object(e), !0).forEach(function (i) {
                w(t, i, e[i]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e))
            : u(Object(e)).forEach(function (i) {
                Object.defineProperty(
                  t,
                  i,
                  Object.getOwnPropertyDescriptor(e, i)
