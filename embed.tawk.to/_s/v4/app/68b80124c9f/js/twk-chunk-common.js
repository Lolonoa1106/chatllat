  ...
  ["chunk-common"],
  {
              ...
              if (
                ...
                if (k || "v" === t.ut) s = this.parseText(t.m);
                  ...
                  var x = this.parseSurvey(t.m),
                    L = x.parsedMessage,
                    A = x.surveyOptions;
                  (s = r.a.rawDecodeHTMLSymbols(L)), A && (m = { options: A });
                }
              }
              return (
      ...
      e.default = {
        ...
        getters: {
          ...
          getLogoContent: function (t, e, n) {
            for (
              var i = n.session.pageStatus, r = t.states[i], o = 0;
              o < r.header.length;
              o++
            ) {
        ...
        mutations: {
          ...
          setData: function (t, e) {
            (t.version = e.version),
              ...
              (t.theme = e.theme);
            var n = JSON.parse(JSON.stringify(e.states));
            for (var i in n)
              n[i] &&
                n[i].body &&
                (n[i].body = n[i].body.filter(function (t) {
            ...
            if (
              ...
              var r = e.visibility.desktop.position,
                o = e.minimized.desktop.type;
              (("cr" !== r && "rectangle" !== o) ||
                ("cl" !== r && "rectangle" !== o)) &&
          ...
          function () {
            ...
            return e(
              ...
              [
                ...
                e("div", { attrs: { id: "branding-widget" } }),
      ...
      var l = function () {
        ...
        try {
          for (r.s(); !(t = r.n()).done; ) {
            var o = t.value;
            if (
              o.href.includes("cdn.shopify.com") ||
              o.href.includes("shopifycdn.com")
            ) {
              e = !0;
              break;
            }
        ...
        if (!e) {
          var s,
            c = a(document.scripts);
          try {
            for (c.s(); !(s = c.n()).done; ) {
              var l = s.value;
              if (
                l.src.includes("cdn.shopify.com") ||
                l.src.includes("shopifycdn.com")
              ) {
                n = !0;
                break;
              }
                ...
                .init(
                  {
                    ...
                    backend: {
                      loadPath: "".concat(
                        "https://embed.tawk.to/_s/v4/app/68b80124c9f",
                        "/languages/{{lng}}.json"
                      ),
                    },
                  },
                    ...
                    5 !== this.connectCount
                      ? (this.io &&
                        ...
                        this.io.on("error", function (t) {
                          ...
                          i.a.reportError({ error: r, data: l({}, e) }),
                            n.io.disconnect(),
                            n.disconnectHandler();
                        }),
    ...
    6665: function (t, e, n) {
      ...
      function o() {
        ...
        return (
          (y.prototype = b),
          a(P, "constructor", { value: b, configurable: !0 }),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                e.transfer &&
                  ...
                  e.cc && b.a.dispatch("session/setCountryCode", e.cc),
                  this.callback();
              },
            },
            {
